...
pixi add check-jsonschema
# for installing globally
pixi global install check-jsonschema
```
...
It is possible to list all of the versions of `check-jsonschema` available on your platform:
...
```
pixi search check-jsonschema --channel conda-forge
```
